...
class InitDatabase {
    ...
    CommandLineRunner initPost(PostRepository postRepository) {
        return args -> {
            ...
            System.out.println("Init Post " + postRepository.save(new Post(null,"WKWKWK masak 2 sih", 3, new Long(4), new Long(1), new Long(2), "http://www.anekabangunan.com/wp-content/uploads/2018/11/7Cara-Mengatasi-Tembok-Retak-Rambut.jpg")));
